    ...
    >
      ...
      >
        ...
        <span className="text-primary-contrast text-xs font-semibold tracking-wider uppercase">
          Empowering Latin America Builders
        </span>
      </div>

      {/* Main Title - Removed text-shimmer class */}
      <h1
        className="dark:text-primary font-heading text-foreground mb-6 cursor-default tracking-wide transition-all delay-300 duration-1000"
        style={{
      ...
      {/* Subtitle */}
      <p className="text-foreground mb-4 max-w-2xl text-lg leading-relaxed transition-all delay-400 duration-1000 md:text-xl">
        Your gateway to{" "}
        <span className="text-primary-contrast font-semibold">workshops</span>,{" "}
        <span className="text-primary-contrast font-semibold">courses</span>,{" "}
        <span className="text-primary-contrast font-semibold">hackathons</span>,
        and{" "}
      ...
      <p className="text-muted-foreground mb-12 text-sm transition-all delay-500 duration-1000 md:text-base">
        Join thousands of developers building the future together
      </p>

      {/* CTA Buttons */}
      <div className="flex flex-col items-center gap-6 transition-all delay-600 duration-1000 sm:flex-row">
        <Button
          size="lg"
      ...
      {/* Stats Grid */}
      <div className="mt-24 grid grid-cols-2 gap-x-12 gap-y-8 transition-all delay-700 duration-1000 md:grid-cols-4 md:gap-x-16">
        {[
          { icon: UsersIcon, value: "5000+", label: "BUILDERS" },
          { icon: CalendarIcon, value: "120+", label: "EVENTS" },
          { icon: TrophyIcon, value: "50+", label: "HACKATHONS" },
          { icon: GlobeIcon, value: "18", label: "COUNTRIES" },
        ].map((stat, i) => (
          <div
            key={i}
