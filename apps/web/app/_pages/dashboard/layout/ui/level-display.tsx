      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="flex w-28 cursor-default flex-col gap-1">
            ...
            <div className="bg-background relative flex h-6 w-full items-center overflow-hidden rounded-full border p-1">
              {/* Track background */}
              <div className="bg-border absolute inset-1 rounded-full" />
              {/* Progress fill with gradient */}
              <div
                className="relative z-10 h-full rounded-full bg-linear-to-r from-amber-600 via-amber-400 to-amber-300 transition-all duration-300"
