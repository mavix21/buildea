...
export default function generator(plop: PlopTypes.NodePlopAPI): void {
  ...
  plop.setGenerator("init", {
    description: "Generate a new package for the buildea Monorepo",
    prompts: [
      {
        type: "input",
        name: "name",
        message:
          "What is the name of the package? (You can skip the `@buildea/` prefix)",
      },
      {
        type: "input",
        name: "deps",
    ...
    actions: [
      (answers) => {
        if ("name" in answers && typeof answers.name === "string") {
          if (answers.name.startsWith("@buildea/")) {
            answers.name = answers.name.replace("@buildea/", "");
          }
        }
  ...
  plop.setGenerator("feature", {
    description: "Generate a new feature slice in @buildea/features",
    prompts: [
      {
        type: "input",
        name: "name",
  ...
  plop.setGenerator("entity", {
    description: "Generate a new entity slice in @buildea/features",
    prompts: [
      {
        type: "input",
        name: "name",
  ...
  plop.setGenerator("widget", {
    description: "Generate a new widget slice in @buildea/features",
    prompts: [
      {
        type: "input",
        name: "name",
  ...
  plop.setGenerator("page", {
    description: "Generate a new shared page in @buildea/features",
    prompts: [
      {
        type: "input",
        name: "name",
