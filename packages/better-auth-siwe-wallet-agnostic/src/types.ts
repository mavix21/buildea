...
export interface SiweWalletAgnosticOptions {
   ...
   * - For standard ports (80/443), browsers omit the port: "buildea.com"
   * - For non-standard ports, include it: "localhost:3000"
   *
   * This prevents cross-domain replay attacks. An attacker cannot use
   * a SIWE message signed for "evil.com" to authenticate on "buildea.com".
   *
   * @example "buildea.com" for production (HTTPS on port 443)
   ...
   * - For standard ports: "https://buildea.com"
   * - For non-standard ports: "http://localhost:3000"
   *
   * @example "https://buildea.com" for production
   ...
   *
   * @example "buildea.com" → "0x123...abc@buildea.com"
   */
