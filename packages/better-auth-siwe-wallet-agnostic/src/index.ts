...
export const siweWalletAgnostic = (
  ...
  if (domain.includes("://")) {
    throw new Error(
      "[siwe-wallet-agnostic] 'domain' should be a hostname without protocol (e.g., 'buildea.com' not 'https://buildea.com')",
    );
  }
  ...
  if (!uri.startsWith("http://") && !uri.startsWith("https://")) {
    throw new Error(
      "[siwe-wallet-agnostic] 'uri' must include protocol (e.g., 'https://buildea.com')",
    );
  }
